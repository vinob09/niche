...
def get_curr_user_products():
    ...
    return render_template('/categoryComponent', products_data=products_data)
...
def get_products_by_category(category_id):
    ...
    return render_template('/categorydetail.html', products_data=products_data)
...
def get_categories():
    ...
    return render_template('categoryMenuComp', categories_data=categories_data)